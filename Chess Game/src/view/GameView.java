...
public class GameView {
    ...
    private void setPlayerWhitePane() {
        ...
        try {
            ...
            URL url = new URL("https://upload.wikimedia.org/wikipedia/en/f/fa/Zoomandbored.jpg");
    ...
    private void setPlayerBlackPane() {
        ...
        try {
            //Online source for the Chess Piece Images
            URL url = new URL("https://upload.wikimedia.org/wikipedia/en/8/88/Tobeepornottobeep.jpg");
            BufferedImage bi = ImageIO.read(url);
    ...
    public void drawPiecesForNewGame(){
        ...
        try {
            //Online source for the Chess Piece Images
            URL url = new URL("https://images2.imgbox.com/a3/d8/HRPu8TWC_o.png");
            BufferedImage bi = ImageIO.read(url);
