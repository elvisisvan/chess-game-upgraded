...
public class ChessBox {
     ...
     * @return
     */
    public static char convertColumnNumber(int f)
    {
     ...
     * @return
     */
    public static int convertRowNumber(int r)
    {
        return (r+1);
    }
     ...
     * @return
     */
    public static int convertColumnCharacter(char f)
    {
     ...
     * @return
     */
    public static int convertRowCharacter(char r)
    {
        return (r - '1');
    }
